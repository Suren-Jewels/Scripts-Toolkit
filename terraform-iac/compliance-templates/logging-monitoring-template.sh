...
# Logging & monitoring compliance template:
# - Audit log retention
# - Centralized monitoring patterns
# - SIEM forwarding guardrails
...
TF_DIR="${TEMPLATE_DIR}/logging-monitoring"
...
echo "Logging & monitoring compliance template ${ACTION} completed for environment: ${ENVIRONMENT}"

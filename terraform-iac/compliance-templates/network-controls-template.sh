...
# Network controls compliance template:
# - Zero Trust segmentation
# - Firewall and perimeter policies
# - Network ACL and routing guardrails
...
TF_DIR="${TEMPLATE_DIR}/network-controls"
...
echo "Network controls compliance template ${ACTION} completed for environment: ${ENVIRONMENT}"

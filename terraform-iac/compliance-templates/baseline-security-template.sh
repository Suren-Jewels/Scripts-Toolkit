...
# Baseline security compliance template:
# - CIS baseline controls
# - Identity, MFA, encryption, logging defaults
...
TF_DIR="${TEMPLATE_DIR}/baseline-security"
...
echo "Baseline security compliance template ${ACTION} completed for environment: ${ENVIRONMENT}"

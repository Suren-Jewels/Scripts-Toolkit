#!/usr/bin/env python3
"""
Capability: Send pod-walk notifications to Slack or Teams.
Requires one of:
- SLACK_WEBHOOK
- TEAMS_WEBHOOK

Environment:
- RUN_DIR: directory containing the latest pod-walk results
"""
...
summary = {
    ...
    "message": "Pod walk completed successfully.",
}

#!/usr/bin/env python3
"""
Capability: Send reserve-pool notifications to Slack or Teams.
Requires one of:
- SLACK_WEBHOOK
- TEAMS_WEBHOOK

Environment:
- RUN_DIR: directory containing the latest reserve-pool audit results
"""
...
summary = {
    ...
    "message": "Reserve pool audit completed successfully."
}
